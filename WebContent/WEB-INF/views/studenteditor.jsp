	...
	<form action="" method="post" class="form form-horizontal responsive" id="demoform-2">
          <div class="row cl">
            ...
            <div class="formControls col-5">
              ...
              <input type="text" class="input-text" placeholder="请输入申请人姓名" name="studentname" id="studentname" datatype="s2-5" nullmsg="申请人姓名不能为空"  value = "${studentone.stuName}">
            </div>
            <div class="col-5">
            </div>
          </div>
          <div class="row cl">
            ...
            <div class="formControls col-5">
              <input type="text" class="input-text" placeholder="请输入申请人所在系" name="studentsystem" id="studentsystem" datatype="s2-10" nullmsg="所在系不能为空" value = "${studentone.stuSystem}">
            </div>
            <div class="col-5">
            </div>
          </div>
          ...
          <div class="row cl">
            ...
            <div class="formControls col-5">
              <input type="text" class="input-text" placeholder="请输入申请人班级" name="studentclass" id="studentclass" datatype="s2-10" nullmsg="班级不能为空" value = "${studentone.stuClass}">
            </div>
            <div class="col-5">
            </div>
          </div>
          <div class="row cl">
            <label class="form-label col-2">申请人性别：</label>
