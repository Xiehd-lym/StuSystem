            ...
            <form class=" animated rollIn" data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
                ...
                <fieldset>
	                <label class="radio-inline"  >
					  <input type="radio" name="inlineRadioOptions" id="inlineRadio1" checked value="1" data-rule="checked"> 管理员
					</label>
					<!-- 
					<label class="radio-inline">
					 ...
					 -->
					<label class="radio-inline">
					  <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="3" > 申请人
					</label>
